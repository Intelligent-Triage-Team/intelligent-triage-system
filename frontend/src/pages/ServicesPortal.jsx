...
function ServicesPortal() {
              ...
              <div className="row">
                {services.map((service, index) => (
                  <div key={index} className="col-lg-4 col-md-6 mb-4">
                    <div className="card h-100 service-card shadow-sm" onClick={() => {
                      if (!requireAuth()) return;
                      setActiveService(service.id);
                    }}>
                      <div className="card-body text-center">
                        <div className={`service-icon bg-${service.color} bg-opacity-10 mb-3`}>
                          <i className={`fas ${service.icon} fa-3x text-${service.color}`}></i>
                        </div>
                        <h5 className="card-title">{service.name}</h5>
                        <p className="card-text text-muted">{service.description}</p>
                        <button className={`btn btn-${service.color} quick-btn`}>
              ...
              <div className="card shadow-sm mt-4">
                <div className="card-body p-4">
                  ...
                  <div className="row">
                    <div className="col-md-3 mb-3">
                      <button
                        className="btn btn-outline-primary quick-btn"
  ...
  return (
    <div className="services-page">
      {/* Service Navigation */}
      <div className="services-nav border-bottom">
