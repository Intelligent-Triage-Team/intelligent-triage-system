            ...
            <div className="col-lg-4 col-md-6 mb-4">
              <div className="footer-brand">
                <div className="brand-logo">
                  ...
                  <span>Intelligent Healthcare triage  system </span>
                </div>
                ...
                <div className="contact-info">
                  <div className="contact-item">
                    ...
                    <span>Software Solution , ህረር</span>
                  </div>
                  <div className="contact-item">
                    <i className="fas fa-phone"></i>
                    <span>+251 (000) 940 440190</span>
                  </div>
                  <div className="contact-item">
                    <i className="fas fa-envelope"></i>
                    <span>info@healthcareai.com</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="row align-items-center">
            <div className="col-md-6">
              <div className="copyright">
                <p className="mb-0">© {currentYear}HealthCare AI. All rights reserved.</p>
                <p className="mb-0 small">Software Solution company:<br />Developed by 5th Year ECE Students</p>
              </div>
            </div>
            <div className="col-md-6">
